...
unlocked to sign the Bancorcoin-Qt.app bundle.
...
allowing somebody to distribute a Bancorcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the bancorcoin-qt.exe file inside the installer had not been tampered with.
