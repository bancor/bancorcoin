...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Bancorcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start bancorcoin: click-to-pay handler");
    else
...
{
    // clicking on Bancorcoin: URLs creates FileOpen events on the Mac:
